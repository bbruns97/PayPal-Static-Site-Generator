...
---
### 'header'
>`header` is a `layout` dependency. Use `layout` instead.
...
---
### 'footer'
>`footer` is a `layout` dependency. Use `layout` instead.
...
This component does not contain the option to "add to cart" generated through the 'paypalCheckoutOption' component.
...
---
### 'paypalButton'
>`paypalButton` is a `paypalCheckoutOptions` dependency. Use `paypalCheckoutOptions` instead.
...
---
### 'custom-add'
>`custom-add` is a `paypalCheckoutOptions` dependency. Use `paypalCheckoutOptions` instead.
...
---
### 'ShoppingCartIcon'
>`ShoppingCartIcon` is a `header` dependency. Use `header` instead.
...
---
### 'cart-item-list'
>`cart-item-list` is a `cart` dependency. Use `cart` instead.
...
---
### 'cart-item' 
>`cart-item` is a `cart-item-list` dependency. Use `cart` instead.
>
...
---
### 'useLocalStorage'
>`useLocalStorage` is a `react-cart` dependency. Use `react-cart` instead.
